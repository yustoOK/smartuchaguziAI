...
def generate_training_data(num_samples=1_500_000, fraud_ratio=0.03):
    data = []
    ...
    # Save to CSV
    df.to_csv('C:\\Users\\yusto\\Desktop\\fraud_data_v2.csv', index=False)
    return df

if __name__ == "__main__":
    print("Generating data...")
    df = generate_training_data()
    print("Data saved to fraud_data_v2.csv")
